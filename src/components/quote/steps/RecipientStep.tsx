...
interface RecipientStepProps {
  data: FreightQuote['recipient'];
  onBack: () => void;
  onComplete: (data: FreightQuote['recipient']) => void;
}
...
export function RecipientStep({ data, onBack, onComplete }: RecipientStepProps) {
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900">Dados do Destinatário</h2>
        <p className="text-gray-600 mt-2">Informe os dados de quem receberá a mercadoria</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:col-span-2">
            <label htmlFor="recipient-name" className="form-label required">Nome Completo / Razão Social</label>
            <input
              id="recipient-name"
              type="text"
          ...
          <div>
            <label htmlFor="recipient-document" className="form-label required">CPF/CNPJ</label>
            <input
          ...
          <div>
            <label htmlFor="recipient-phone" className="form-label required">Telefone</label>
            <input
              id="recipient-phone"
              type="tel"
          ...
          <div className="md:col-span-2">
            <label htmlFor="recipient-email" className="form-label required">Email</label>
            <input
              id="recipient-email"
              type="email"
          ...
          <div className="md:col-span-2">
            <label htmlFor="recipient-street" className="form-label required">Rua</label>
            <input
              id="recipient-street"
              type="text"
          ...
          <div>
            <label htmlFor="recipient-number" className="form-label required">Número</label>
            <input
              id="recipient-number"
              type="text"
          ...
          <div>
            <label htmlFor="recipient-complement" className="form-label">Complemento</label>
            <input
              id="recipient-complement"
              type="text"
          ...
          <div>
            <label htmlFor="recipient-neighborhood" className="form-label required">Bairro</label>
            <input
          ...
          <div>
            <label htmlFor="recipient-zipcode" className="form-label required">CEP</label>
            <input
          ...
          <div>
            <label htmlFor="recipient-city" className="form-label required">Cidade</label>
            <input
              id="recipient-city"
              type="text"
          ...
          <div>
            <label htmlFor="recipient-state" className="form-label required">Estado</label>
            <input
              id="recipient-state"
              type="text"
